...
log_file.write("Timestamp (s), Altitude (m), Roll (deg), Pitch (deg), Velocity Z (deg/s), Alt Derivative (m/s), Event, GPS UTC, GPS Lat, GPS Lon, GPS Fix, GPS Sats, GPS Alt (m), GPS Speed (m/s)\n")
log_file.flush()
...
while True:
    try:
        ...
        # === Logging ===
        log_file.write(
            f"{timestamp:.2f},{altitude:.2f},{roll:.2f},{pitch_angle:.2f},{velocity_z:.2f},{dz:.2f},{event},{gps_utc},{gps_lat},{gps_lon},{gps_fix},{gps_sats},{gps_alt},{gps_speed}\n"
        )
